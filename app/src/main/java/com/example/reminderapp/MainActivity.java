...
public class MainActivity extends AppCompatActivity {
    ...
    public void loginUser(String user,String pass){
        ...
        if(temp==null){
            Toast.makeText(MainActivity.this,"Invalid username Input",Toast.LENGTH_SHORT).show();
        }
        else{
            if(temp.getPassword().equals(pass)){
                ...
                Toast.makeText(MainActivity.this,"Invalid Password Input",Toast.LENGTH_SHORT).show();
            }
        }
